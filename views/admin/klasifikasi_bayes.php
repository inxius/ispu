             ...
             <div class="col-md-12 col-sm-12 text-center">
               <table class="table table-responsive table-borderless table-striped">
                 <tbody class="table-wrapper-scroll-y my-custom-scrollbar">
                   ...
                   <tr class="d-flex align-items-center">
                     <td>
                       = <script> document.write(likelihood[0]+" / "+likelihood[0]+"+"+likelihood[1]+"+"+likelihood[2]+"+"+likelihood[3]+" = "+probAkhir[0]); </script>
                     </td>
                   </tr>
                   <tr class="d-flex align-items-center">
                   ...
                   <tr class="d-flex align-items-center">
                     <td>
                       = <script> document.write(likelihood[1]+" / "+likelihood[0]+"+"+likelihood[1]+"+"+likelihood[2]+"+"+likelihood[3]+" = "+probAkhir[1]); </script>
                     </td>
                   </tr>
                   <tr class="d-flex align-items-center">
                   ...
                   <tr class="d-flex align-items-center">
                     <td>
                       = <script> document.write(likelihood[2]+" / "+likelihood[0]+"+"+likelihood[1]+"+"+likelihood[2]+"+"+likelihood[3]+" = "+probAkhir[2]); </script>
                     </td>
                   </tr>
                   <tr class="d-flex align-items-center">
                   ...
                   <tr class="d-flex align-items-center">
                     <td>
                       = <script> document.write(likelihood[3]+" / "+likelihood[0]+"+"+likelihood[1]+"+"+likelihood[2]+"+"+likelihood[3]+" = "+probAkhir[3]); </script>
                     </td>
                   </tr>
                 </tbody>
               </table>
